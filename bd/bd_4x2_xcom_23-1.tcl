...
\
  ...
  # Create instance: rst_tclk, and set properties
  set rst_tclk [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_tclk ]
  ...
  # Create instance: rst_cclk, and set properties
  set rst_cclk [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_cclk ]
  ...
  # Create instance: qick_xcom_0, and set properties
  set qick_xcom_0 [ create_bd_cell -type ip -vlnv Fermi:user:qick_xcom:1.0 qick_xcom_0 ]
  set_property CONFIG.CH {3} $qick_xcom_0


  # Create instance: qick_xcom_1, and set properties
  set qick_xcom_1 [ create_bd_cell -type ip -vlnv Fermi:user:qick_xcom:1.0 qick_xcom_1 ]
  set_property CONFIG.CH {3} $qick_xcom_1


  # Create instance: qick_xcom_2, and set properties
  set qick_xcom_2 [ create_bd_cell -type ip -vlnv Fermi:user:qick_xcom:1.0 qick_xcom_2 ]
  set_property CONFIG.CH {3} $qick_xcom_2


  # Create instance: ck_bus, and set properties
  set ck_bus [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 ck_bus ]
  set_property CONFIG.NUM_PORTS {3} $ck_bus


  # Create instance: dt_bus, and set properties
  set dt_bus [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 dt_bus ]
  set_property CONFIG.NUM_PORTS {3} $dt_bus
  ...
  connect_bd_intf_net -intf_net axi_dma_tproc_M_AXI_MM2S [get_bd_intf_pins axi_dma_tproc/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_tproc_M_AXI_S2MM [get_bd_intf_pins axi_dma_tproc/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S01_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins axi_dma_tproc/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins qick_xcom_0/s_axi]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins qick_xcom_1/s_axi]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins qick_xcom_2/s_axi]
  connect_bd_intf_net -intf_net qick_processor_0_QCOM [get_bd_intf_pins qick_processor_0/QCOM] [get_bd_intf_pins qick_xcom_0/QICK_PERIPHERAL]
  connect_bd_intf_net -intf_net qick_processor_0_QPeriphA [get_bd_intf_pins qick_processor_0/QPeriphA] [get_bd_intf_pins qick_xcom_1/QICK_PERIPHERAL]
  connect_bd_intf_net -intf_net qick_processor_0_QPeriphB [get_bd_intf_pins qick_processor_0/QPeriphB] [get_bd_intf_pins qick_xcom_2/QICK_PERIPHERAL]
  ...
  connect_bd_net -net Net8 [get_bd_pins qick_processor_0/trig_0_o] [get_bd_pins qick_xcom_2/pulse_sync_i] [get_bd_pins qick_xcom_0/pulse_sync_i] [get_bd_pins qick_xcom_1/pulse_sync_i]
  connect_bd_net -net ck_bus_dout [get_bd_pins ck_bus/dout] [get_bd_pins qick_xcom_2/xcom_ck_i] [get_bd_pins qick_xcom_0/xcom_ck_i] [get_bd_pins qick_xcom_1/xcom_ck_i]
  connect_bd_net -net clk_adc0_x2_clk_out1 [get_bd_pins c_clk/clk_out1] [get_bd_pins rst_cclk/slowest_sync_clk] [get_bd_pins qick_processor_0/c_clk_i] [get_bd_pins qick_xcom_2/c_clk] [get_bd_pins qick_xcom_0/c_clk] [get_bd_pins qick_xcom_1/c_clk] [get_bd_pins axis_constant_0/m_axis_aclk]
  connect_bd_net -net clk_adc0_x2_locked [get_bd_pins c_clk/locked] [get_bd_pins rst_cclk/dcm_locked]
  connect_bd_net -net clk_adc2_x2_clk_out1 [get_bd_pins t_clk/clk_out1] [get_bd_pins qick_processor_0/t_clk_i] [get_bd_pins qick_xcom_2/t_clk] [get_bd_pins qick_xcom_0/t_clk] [get_bd_pins qick_xcom_1/t_clk] [get_bd_pins qick_xcom_2/x_clk] [get_bd_pins qick_xcom_0/x_clk] [get_bd_pins qick_xcom_1/x_clk] [get_bd_pins rst_tclk/slowest_sync_clk]
  connect_bd_net -net dt_bus_dout [get_bd_pins dt_bus/dout] [get_bd_pins qick_xcom_2/xcom_dt_i] [get_bd_pins qick_xcom_1/xcom_dt_i] [get_bd_pins qick_xcom_0/xcom_dt_i]
  connect_bd_net -net qick_xcom_0_qproc_start_o [get_bd_pins qick_xcom_0/qproc_start_o] [get_bd_pins qick_processor_0/proc_start_i]
  connect_bd_net -net qick_xcom_0_xcom_ck_o [get_bd_pins qick_xcom_0/xcom_ck_o] [get_bd_pins ck_bus/In0]
  connect_bd_net -net qick_xcom_0_xcom_dt_o [get_bd_pins qick_xcom_0/xcom_dt_o] [get_bd_pins dt_bus/In0]
  connect_bd_net -net qick_xcom_1_xcom_ck_o [get_bd_pins qick_xcom_1/xcom_ck_o] [get_bd_pins ck_bus/In1]
  connect_bd_net -net qick_xcom_1_xcom_dt_o [get_bd_pins qick_xcom_1/xcom_dt_o] [get_bd_pins dt_bus/In1]
  connect_bd_net -net qick_xcom_2_xcom_ck_o [get_bd_pins qick_xcom_2/xcom_ck_o] [get_bd_pins ck_bus/In2]
  connect_bd_net -net qick_xcom_2_xcom_dt_o [get_bd_pins qick_xcom_2/xcom_dt_o] [get_bd_pins dt_bus/In2]
  connect_bd_net -net rst_cclk_peripheral_aresetn [get_bd_pins rst_cclk/peripheral_aresetn] [get_bd_pins qick_processor_0/c_resetn] [get_bd_pins qick_xcom_2/c_aresetn] [get_bd_pins qick_xcom_0/c_aresetn] [get_bd_pins qick_xcom_1/c_aresetn] [get_bd_pins axis_constant_0/m_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_100/peripheral_aresetn] [get_bd_pins axi_dma_tproc/axi_resetn] [get_bd_pins qick_processor_0/ps_resetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins qick_xcom_2/ps_aresetn] [get_bd_pins qick_xcom_0/ps_aresetn] [get_bd_pins qick_xcom_1/ps_aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN]
  connect_bd_net -net rst_tclk_peripheral_aresetn [get_bd_pins rst_tclk/peripheral_aresetn] [get_bd_pins qick_processor_0/t_resetn] [get_bd_pins qick_xcom_2/t_aresetn] [get_bd_pins qick_xcom_0/t_aresetn] [get_bd_pins qick_xcom_1/t_aresetn] [get_bd_pins qick_xcom_2/x_aresetn] [get_bd_pins qick_xcom_0/x_aresetn] [get_bd_pins qick_xcom_1/x_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins rst_100/slowest_sync_clk] [get_bd_pins axi_dma_tproc/s_axi_lite_aclk] [get_bd_pins axi_dma_tproc/m_axi_mm2s_aclk] [get_bd_pins axi_dma_tproc/m_axi_s2mm_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins qick_processor_0/ps_clk_i] [get_bd_pins c_clk/clk_in1] [get_bd_pins t_clk/clk_in1] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins qick_xcom_2/ps_clk] [get_bd_pins qick_xcom_0/ps_clk] [get_bd_pins qick_xcom_1/ps_clk] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_100/ext_reset_in] [get_bd_pins rst_tclk/ext_reset_in] [get_bd_pins rst_cclk/ext_reset_in] [get_bd_pins c_clk/resetn] [get_bd_pins t_clk/resetn]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_tproc/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs qick_xcom_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0021000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs qick_xcom_1/s_axi/reg0] -force
  assign_bd_address -offset 0xA0022000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs qick_xcom_2/s_axi/reg0] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.550718",
   "Default View_TopLeft":"-1369,-111",
   ...
   "PinnedBlocks":"/zynq_ultra_ps_e_0|/rst_100|/c_clk|/axi_dma_tproc|/t_clk|/qick_processor_0|/axi_smc|/ps8_0_axi_periph|/qick_xcom_1|/qick_xcom_2|/qick_xcom_0|/ck_bus|/dt_bus|",
   "commentid":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port port-id_PMOD0_0 -pg 1 -lvl 6 -x 2000 -y 600 -defaultsOSRD
preplace inst rst_100 -pg 1 -lvl 4 -x 1320 -y 240 -defaultsOSRD
preplace inst axi_dma_tproc -pg 1 -lvl 2 -x 440 -y 870 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 4 -x 1320 -y 40 -defaultsOSRD
preplace inst rst_tclk -pg 1 -lvl 4 -x 1320 -y 460 -defaultsOSRD -resize 320 156
preplace inst qick_processor_0 -pg 1 -lvl 2 -x 440 -y 1240 -defaultsOSRD
preplace inst rst_cclk -pg 1 -lvl 4 -x 1320 -y 700 -defaultsOSRD
preplace inst c_clk -pg 1 -lvl 3 -x 780 -y 670 -defaultsOSRD
preplace inst t_clk -pg 1 -lvl 3 -x 780 -y 430 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 5 -x 1810 -y 100 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 440 -y 30 -defaultsOSRD
preplace inst qick_xcom_0 -pg 1 -lvl 4 -x 1320 -y 1330 -defaultsOSRD
preplace inst qick_xcom_1 -pg 1 -lvl 4 -x 1320 -y 1670 -defaultsOSRD
preplace inst qick_xcom_2 -pg 1 -lvl 4 -x 1320 -y 2010 -defaultsOSRD
preplace inst ck_bus -pg 1 -lvl 5 -x 1810 -y 1350 -defaultsOSRD
preplace inst dt_bus -pg 1 -lvl 5 -x 1810 -y 1490 -defaultsOSRD
preplace inst axis_constant_0 -pg 1 -lvl 1 -x 70 -y 1150 -defaultsOSRD
preplace netloc qick_processor_0_trig_0_o 1 2 4 680 600 N 600 N 600 N
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 4 220 -80 N -80 960 -80 1640
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 1 4 230 440 670 500 970 -60 1670
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 3 690 510 980 -70 1610
preplace netloc clk_adc0_x2_locked 1 3 1 950 680n
preplace netloc clk_adc0_x2_clk_out1 1 0 4 -50 1220 200 1050 N 1050 940
preplace netloc clk_adc2_x2_clk_out1 1 1 3 240 1060 N 1060 920
preplace netloc rst_tclk_peripheral_aresetn 1 1 4 280 1090 N 1090 890 1090 1640
preplace netloc rst_cclk_peripheral_aresetn 1 0 5 -60 1230 210 1080 N 1080 910 1080 1610
preplace netloc Net8 1 3 1 1020 1410n
preplace netloc qick_xcom_0_qproc_start_o 1 1 4 260 1070 N 1070 N 1070 1620
preplace netloc qick_xcom_0_xcom_ck_o 1 4 1 N 1330
preplace netloc qick_xcom_1_xcom_ck_o 1 4 1 1630 1350n
preplace netloc qick_xcom_0_xcom_dt_o 1 4 1 1620 1350n
preplace netloc qick_xcom_1_xcom_dt_o 1 4 1 1650 1490n
preplace netloc qick_xcom_2_xcom_ck_o 1 4 1 1640 1370n
preplace netloc qick_xcom_2_xcom_dt_o 1 4 1 1660 1510n
preplace netloc ck_bus_dout 1 3 3 980 1140 NJ 1140 1950
preplace netloc dt_bus_dout 1 3 3 1000 1150 NJ 1150 1970
preplace netloc axi_dma_tproc_M_AXIS_MM2S 1 1 2 270 990 600
preplace netloc qick_processor_0_m_dma_axis_o 1 1 2 280 750 620
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 4 1 1650 -40n
preplace netloc ps8_0_axi_periph_M00_AXI 1 1 5 200 -100 NJ -100 NJ -100 NJ -100 1950
preplace netloc ps8_0_axi_periph_M01_AXI 1 1 5 250 140 N 140 N 140 1650J 300 1960
preplace netloc axi_dma_tproc_M_AXI_MM2S 1 1 2 230 -70 600J
preplace netloc axi_smc_M00_AXI 1 2 2 640 0 N
preplace netloc axi_dma_tproc_M_AXI_S2MM 1 1 2 280 -60 610
preplace netloc qick_processor_0_QCOM 1 2 2 N 1230 NJ
preplace netloc qick_processor_0_QPeriphA 1 2 2 N 1250 930
preplace netloc qick_processor_0_QPeriphB 1 2 2 N 1270 900
preplace netloc ps8_0_axi_periph_M02_AXI 1 3 3 990 340 NJ 340 1980
preplace netloc ps8_0_axi_periph_M03_AXI 1 3 3 1010 350 NJ 350 1970
preplace netloc ps8_0_axi_periph_M04_AXI 1 3 3 1030 360 NJ 360 1950
preplace netloc axis_constant_0_m_axis 1 1 1 N 1150
levelinfo -pg 1 -80 70 440 780 1320 1810 2000
pagesize -pg 1 -db -bbox -sgen -180 -200 2590 2190
"
}
