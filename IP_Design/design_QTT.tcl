...
puts "###############################################################"
puts "QICK TIME TAGGER PERIPHERAL DESIGN"
puts "###############################################################"
puts "Directory Structure"
puts "/IPs/qick_time_tagger     > Qick IP Block"
puts "/Projects/22.1/IP_design  > Run script and generate Project"
puts "###############################################################"

set ip_path  "$origin_dir/../../../IPs/qick_time_tagger/"
set src_path "$origin_dir/../../../IPs/qick_time_tagger/src/"
set tb_path  "$origin_dir/../../../IPs/qick_time_tagger/src/TB/"
...
set _xil_proj_name_ "IP_qick_time_tagger_design"
