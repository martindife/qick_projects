...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NMEM" -parent ${Page_0}
...
proc update_PARAM_VALUE.NMEM { PARAM_VALUE.NMEM } {
	# Procedure called to update NMEM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NMEM { PARAM_VALUE.NMEM } {
	# Procedure called to validate NMEM
	return true
}
...
proc update_MODELPARAM_VALUE.NMEM { MODELPARAM_VALUE.NMEM PARAM_VALUE.NMEM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NMEM}] ${MODELPARAM_VALUE.NMEM}
}
