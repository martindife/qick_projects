...
set_property -dict [list \
	...
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_0.coe} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_1.coe} \
	CONFIG.Coefficient_Sets {8} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {8} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_2.coe} \
	CONFIG.Coefficient_Sets {8} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {8} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_3.coe} \
	CONFIG.Coefficient_Sets {8} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {8} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_4.coe} \
	CONFIG.Coefficient_Sets {8} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {8} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_5.coe} \
	CONFIG.Coefficient_Sets {8} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {8} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_6.coe} \
	CONFIG.Coefficient_Sets {8} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {8} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/rfsoc-vivado-2022-1/ip/axis_pfbsynth_4x64_v1/src/fir/coef/fir_7.coe} \
	CONFIG.Coefficient_Sets {8} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {8} \
	CONFIG.Number_Paths {2} \
